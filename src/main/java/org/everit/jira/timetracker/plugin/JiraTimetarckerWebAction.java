...
public class JiraTimetarckerWebAction extends JiraWebActionSupport {
	...
	/**
	 * The edit all function save action. Save the worklogs in the given date.
	 * The worklogs come form the editAllIds, the date from the dateFormated.
	 * 
	...
	/**
	 * Handle the editAllIds and the editedWorklogIds variable values. If the
