...
public class IssueEstimatedTimeChecker implements Runnable {
  ...
  private String createBodyString(final MutableIssue issue) {
    String baseURL = ComponentManager.getInstance().getApplicationProperties()
  ...
  /**
   * The IssueEstimatedTimeChecker rum method. Check the last 24 hour. Make a worklog query for the
