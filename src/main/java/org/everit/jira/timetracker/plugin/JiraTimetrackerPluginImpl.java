...
public class JiraTimetrackerPluginImpl implements JiraTimetrackerPlugin,
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        issueEstimatedTimeCheckerFuture = scheduledExecutorService
                .scheduleAtFixedRate(issueEstimatedTimeChecker,
                        calculateInitialDelay(issueCheckTimeInMinutes),
                        JiraTimetrackerPluginImpl.ONE_DAY_IN_MINUTES, TimeUnit.MINUTES);
    }
    ...
    private long calculateInitialDelay(final long time) {
        ...
        if (initialDelay < 0) {
            initialDelay = initialDelay + JiraTimetrackerPluginImpl.ONE_DAY_IN_MINUTES;
        }
        return initialDelay;
    }
    ...
    public void destroy() throws Exception {
        ...
        JiraTimetrackerPluginImpl.LOGGER.info("JiraTimetrackerPluginImpl destroyed");
    }
    ...
    public PluginSettingsValues loadPluginSettings() {
        ...
        List<String> tempIssuePatternList = (List<String>) globalSettings
                .get(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_KEY_PREFIX
                        + JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_SUMMARY_FILTERS);
        ...
        tempIssuePatternList = (List<String>) globalSettings
                .get(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_KEY_PREFIX
                        + JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_NON_ESTIMATED_ISSUES);
        if (tempIssuePatternList != null) {
        ...
        String tempSpecialDates = (String) globalSettings
                .get(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_KEY_PREFIX
                        + JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_EXCLUDE_DATES);
        ...
        tempSpecialDates = (String) globalSettings
                .get(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_KEY_PREFIX
                        + JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_INCLUDE_DATES);
        if (tempSpecialDates != null) {
        ...
        pluginSettings = settingsFactory
                .createSettingsForKey(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_KEY_PREFIX
                        + user.getName());
        Integer isPopup = null;
        if (pluginSettings.get(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_IS_CALENDAR_POPUP) != null) {
            try {
                isPopup = Integer.valueOf(pluginSettings.get(
                        JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_IS_CALENDAR_POPUP).toString());
            } catch (NumberFormatException e) {
                // the default is the popup calendar
                JiraTimetrackerPluginImpl.LOGGER.error(
        ...
        if (pluginSettings.get(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_IS_ACTUAL_DATE) != null) {
            if (pluginSettings.get(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_IS_ACTUAL_DATE).equals(
                    "true")) {
                isActualDate = true;
            } else if (pluginSettings.get(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_IS_ACTUAL_DATE)
                    .equals("false")) {
                isActualDate = false;
            }
        } else {
        ...
        if (pluginSettings.get(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_IS_COLORIG) != null) {
            if (pluginSettings.get(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_IS_COLORIG).equals(
                    "true")) {
                isColoring = true;
            } else if (pluginSettings.get(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_IS_COLORIG)
                    .equals("false")) {
                isColoring = false;
            }
        ...
        if (pluginSettings.get(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_START_TIME_CHANGE) != null) {
            try {
                startTimeChange = Integer.valueOf(pluginSettings.get(
                        JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_START_TIME_CHANGE).toString());
        ...
        if (pluginSettings.get(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_END_TIME_CHANGE) != null) {
            try {
                endTimeChange = Integer.valueOf(pluginSettings.get(
                        JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_END_TIME_CHANGE).toString());
    ...
    public void savePluginSettings(
        ...
        pluginSettings = settingsFactory
                .createSettingsForKey(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_KEY_PREFIX
                        + user.getName());
        pluginSettings.put(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_IS_CALENDAR_POPUP,
                Integer.toString(pluginSettingsParameters.isCalendarPopup()));
        pluginSettings.put(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_IS_ACTUAL_DATE,
                pluginSettingsParameters.isActualDate().toString());
        pluginSettings.put(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_IS_COLORIG,
                pluginSettingsParameters.isColoring().toString());
        pluginSettings
                .put(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_START_TIME_CHANGE,
                        Integer.toString(pluginSettingsParameters
                                .getStartTimeChange()));
        pluginSettings.put(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_END_TIME_CHANGE,
                Integer.toString(pluginSettingsParameters.getEndTimeChange()));

        globalSettings = settingsFactory.createGlobalSettings();
        globalSettings.put(JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_KEY_PREFIX
                + JiraTimetrackerPluginImpl.JTTP_PLUGIN_SETTINGS_SUMMARY_FILTERS,
