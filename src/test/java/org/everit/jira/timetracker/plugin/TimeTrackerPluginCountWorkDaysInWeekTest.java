...
public class TimeTrackerPluginCountWorkDaysInWeekTest {
  ...
  public void testWithoutExcludeAndInclude() throws ParseException {
    ...
    JiraTimetrackerPluginImpl jiraTimetrackerPluginImpl =
        new JiraTimetrackerPluginImpl(mockConfiguration, null, null);
    ...
    double workDaysInWeek =
        jiraTimetrackerPluginImpl.countRealWorkDaysInWeek(weekdays, Collections.EMPTY_SET,
  ...
  public void testWithExcludeAndIncludeDay() throws ParseException {
    ...
    double workDaysInWeek =
        jiraTimetrackerPluginImpl.countRealWorkDaysInWeek(weekdays, new HashSet<>(
  ...
  public void testWithExcludeDay() throws ParseException {
    ...
    double workDaysInWeek =
        jiraTimetrackerPluginImpl.countRealWorkDaysInWeek(weekdays, new HashSet<>(Arrays.asList(
            DateTimeConverterUtil.fixFormatStringToDate("2016-10-25"))),
            Collections.EMPTY_SET);
    Assert.assertEquals(4.0, workDaysInWeek, 0.0001);
  }
