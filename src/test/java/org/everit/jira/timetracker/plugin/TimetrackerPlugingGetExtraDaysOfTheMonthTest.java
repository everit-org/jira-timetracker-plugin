...
public class TimetrackerPlugingGetExtraDaysOfTheMonthTest {
  @Test
  public void testOneExcludeDate() throws ParseException {
    JiraTimetrackerPluginImpl jiraTimetrackerPluginImpl =
        new JiraTimetrackerPluginImpl(null, null, null);
    List<Date> excludeDaysOfTheMonth = jiraTimetrackerPluginImpl.getExcludeDaysOfTheMonth(
  ...
  public void testOneIncludeDate() throws ParseException {
    JiraTimetrackerPluginImpl jiraTimetrackerPluginImpl =
        new JiraTimetrackerPluginImpl(null, null, null);
    List<Date> excludeDaysOfTheMonth = jiraTimetrackerPluginImpl.getIncludeDaysOfTheMonth(
        DateTimeConverterUtil.fixFormatStringToDate("2016-01-05"),
